...
```sh
pnpm --filter @repo-apps/quick-log validate:data
pnpm --filter @repo-apps/quick-log typecheck
pnpm --filter @repo-apps/quick-log test
pnpm --filter @repo-apps/quick-log build
pnpm --filter @repo-apps/quick-log test:e2e
```
